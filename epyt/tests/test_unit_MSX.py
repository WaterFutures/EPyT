...
class MSXtest(unittest.TestCase):
    ...
    def test_MSXgetsource(self):
        self.assertEqual(
            self.msxClass.MSXgetsource(1, 14),
            ('SETPOINT', 2.0, 0),
            'Wrong source comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetsource(2, 1),
            ('CONCEN', 0.8, 0),
            'Wrong source comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetsource(3, 2),
            ('MASS', 0.5, 0),
            'Wrong source comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetsource(4, 3),
            ('FLOWPACED', 4.5, 0),
            'Wrong source comment output',
        )
    ...
    def test_MSXsetsource(self):
        ...
        self.assertEqual(
            self.msxClass.MSXgetsource(1, 1),
            ('NOSOURCE', 10.565, 1),
            'Wrong source comment output',
        )
        ...
        # Set an integer value for level in test_MSXsetsource.
    ...
    def test_MSXgetspecies(self):
        self.assertEqual(
            self.msxClass.MSXgetspecies(1),
            ('BULK', 'MMOL', 1.0e-8, 0.0001),
            'Wrong species comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetspecies(2),
            ('BULK', 'MMOL', 1.0e-8, 0.0001),
            'Wrong species comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetspecies(3),
            ('BULK', 'MMOL', 1.0e-8, 0.0001),
            'Wrong species comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetspecies(4),
            ('BULK', 'MMOL', 1.0e-8, 0.0001),
            'Wrong species comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetspecies(5),
            ('BULK', 'MMOL', 1.0e-8, 0.0001),
            'Wrong species comment output',
        )
    ...
    def test_MSXgetconstant(self):
        self.assertEqual(
            self.msxClass.MSXgetconstant(1),
            0.02,
            'Wrong constant comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetconstant(2),
            0.50,
            'Wrong constant comment output',
        )
    ...
    def testMSXgetinitqual(self):
        self.assertEqual(
            self.msxClass.MSXgetinitqual(1, 1, 9),
            2.818e-08,
            'Wrong get init qual comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetinitqual(1, 1, 10),
            3.55e-7,
            'Wrong get init qual comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetinitqual(1, 1, 8),
            0.004,
            'Wrong get init qual comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetinitqual(0, 1, 9),
            2.818e-08,
            'Wrong get init qual comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetinitqual(0, 1, 10),
            3.55e-7,
            'Wrong get init qual comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetinitqual(0, 1, 8),
            0.004,
            'Wrong get init qual comment output',
        )

    def testMSXsetinitqual(self):
        # Set value as an integer in testMSXsetinitqual.
        self.msxClass.MSXsetinitqual(1, 1, 1, 69)
        self.assertEqual(
            self.msxClass.MSXgetinitqual(1, 1, 1),
            69,
            'Wrong set/get init qual comment output',
        )
        # Set value as a float in testMSXsetinitqual.
    ...
    def test_MSXsetinitqual(self):
        # Set value as an integer in test_MSXsetinitqual.
        self.msxClass.MSXsetinitqual(1, 1, 1, 69)
        self.assertEqual(
            self.msxClass.MSXgetinitqual(1, 1, 1),
            69,
        ...
        # Set value as a float in test_MSXsetinitqual.
        self.msxClass.MSXsetinitqual(1, 1, 1, 69.420)
        self.assertEqual(
            self.msxClass.MSXgetinitqual(1, 1, 1),
            69.420,
    ...
    def test_MSXsetpatternvalue(self):
        # Set value as an integer in test_MSXsetpatternvalue.
        self.msxClass.MSXsetpatternvalue(1, 1, 69)
        self.assertEqual(
            self.msxClass.MSXgetpatternvalue(1, 1),
            69,
            'Wrong set/get patternvalue comment output',
        )
        # Set value as a float in test_MSXsetpatternvalue.
    ...
    def test_MSXgetIDlen(self):
        self.assertEqual(
            self.msxClass.MSXgetIDlen(3, 1),
            4,
            'Wrong get ID len comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetIDlen(3, 2),
            3,
            'Wrong get ID len comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetIDlen(3, 3),
            5,
            'Wrong get ID len comment output',
        )
    ...
    def test_MSXgetID(self):
        self.assertEqual(
            self.msxClass.MSXgetID(3, 1, 4),
            'HOCL',
            'Wrong get ID comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetID(3, 2, 3),
            'NH3',
            'Wrong get ID comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetID(3, 3, 5),
            'NH2CL',
            'Wrong get ID comment output',
        )
    ...
    def test_MSXgetparameter(self):
        self.assertEqual(
            self.msxClass.MSXgetparameter(1, 1, 2),
            0.076,
            'Wrong error comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetparameter(1, 1, 4),
            2.3e-3,
            'Wrong error comment output',
        )

    def test_MSXsetparameter(self):
        # Set value as an integer in test_MSXsetparameter.
        self.msxClass.MSXsetparameter(1, 1, 1, 69)
        self.assertEqual(
            self.msxClass.MSXgetparameter(1, 1, 1),
            69,
            'Wrong error comment output',
        )
        # Set value as a float in test_MSXsetparameter.
    ...
    def test_MSXgetcount(self):
        # For species.
        self.assertEqual(
            self.msxClass.MSXgetcount(3),
            16,
            'Wrong error get count output',
        )
        # For parameters.
        self.assertEqual(
            self.msxClass.MSXgetcount(5),
            11,
            'Wrong error get count output',
        )
        # For constants.
        self.assertEqual(
            self.msxClass.MSXgetcount(6),
            2,
            'Wrong error get count output',
        )
        # For patterns.
        self.assertEqual(
            self.msxClass.MSXgetcount(7),
            2,
            'Wrong error get count output',
        )

    def test_MSXgetindex(self):
        # Testing species (object 3): first, last, 1 char, >1 char, and middle.
        self.assertEqual(
            self.msxClass.MSXgetindex(3, "HOCL"),
            1,
            'Wrong error get count output',
        )
        self.assertEqual(
            self.msxClass.MSXgetindex(3, "cNH2CL"),
            16,
            'Wrong error get count output',
        )
        self.assertEqual(
            self.msxClass.MSXgetindex(3, "H"),
            9,
            'Wrong error get count output',
        )
        self.assertEqual(
            self.msxClass.MSXgetindex(3, "OH"),
            10,
            'Wrong error get count output',
        )
        # Testing parameters (object 5): first, last, and middle.
        self.assertEqual(
            self.msxClass.MSXgetindex(5, "k1"),
            1,
            'Wrong error get count output',
        )
        self.assertEqual(
            self.msxClass.MSXgetindex(5, "kDOC2"),
            11,
            'Wrong error get count output',
        )
        self.assertEqual(
            self.msxClass.MSXgetindex(5, "k6"),
            5,
            'Wrong error get count output',
        )
        # Testing constants (object 6).
        self.assertEqual(
            self.msxClass.MSXgetindex(6, "S1"),
            1,
            'Wrong error get count output',
        )
        self.assertEqual(
            self.msxClass.MSXgetindex(6, "S2"),
            2,
            'Wrong error get count output',
        )
        # Testing patterns (object 7).
        self.assertEqual(
            self.msxClass.MSXgetindex(7, "PAT1"),
            1,
            'Wrong error get count output',
        )
        self.assertEqual(
            self.msxClass.MSXgetindex(7, "PAT2"),
            2,
            'Wrong error get count output',
        )
    ...
    def test_MSXsetpattern(self):
        ...
        self.assertEqual(
            self.msxClass.MSXgetpatternvalue(x, 1),
            0.5,
            'Wrong set/get patternvalue comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetpatternvalue(x, 2),
            0.8,
            'Wrong set/get patternvalue comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetpatternvalue(x, 3),
            1.2,
            'Wrong set/get patternvalue comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetpatternvalue(x, 4),
            1.0,
            'Wrong set/get patternvalue comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetpatternvalue(x, 5),
            0.7,
            'Wrong set/get patternvalue comment output',
        )
        self.assertEqual(
            self.msxClass.MSXgetpatternvalue(x, 6),
            0.3,
            'Wrong set/get patternvalue comment output',
        )

    def test_MSXsavemsxfile(self):
    ...
    def test_MSXgetqual(self):
        ...
        while True:
            ...
            if c == 1:
                self.assertEqual(
                    self.msxClass.MSXgetqual(0, 1, 1),
                    0.8,
